...
enum {
    ...
    TRANSACTION_CONCEPT_REGISTER = 7,
    TRANSACTION_CONCEPT_UNREGISTER = 8,
    TRANSACTION_CONCEPT_AUTHORIZE = 9,
    TRANSACTION_CONCEPT_REVOKE = 10,
    TRANSACTION_CONCEPT_UPDATE = 11,
    TRANSACTION_CONCEPT_TRANSFER = 12,
    TRANSACTION_NUANCE_REGISTER = 13,
    TRANSACTION_NUANCE_UNREGISTER = 14,
    TRANSACTION_NUANCE_AUTHORIZE = 15,
    TRANSACTION_NUANCE_REVOKE = 16,
    TRANSACTION_NUANCE_CHECKPOINT = 17,
    TRANSACTION_NUANCE_TRANSFER = 18,
    TRANSACTION_MCP_REGISTER = 19,
    TRANSACTION_MCP_UNREGISTER = 20,
    TRANSACTION_MCP_AUTHORIZE = 21,
    TRANSACTION_MCP_REVOKE = 22,
    TRANSACTION_MCP_CHECK = 23,
    TRANSACTION_MCP_TRANSFER = 24
};
...
public:
    ...
    {
        // "Dust" is defined in terms of CTransaction::minRelayTxFee, which has units notions-per-kilobyte.
        // If you'd pay more than 1/3 in fees to spend something, then we consider it dust.
        // A typical spendable txout is 34 bytes big, and will need a CTxIn of at least 148 bytes to spend
        // i.e. total is 148 + 34 = 182 bytes. Default -minrelaytxfee is 1000 notions per kB
        // and that means that fee per spendable txout is 182 * 1000 / 1000 = 182 notions.
        // So dust is a spendable txout less than 546 * minRelayTxFee / 1000 (in notions)
        // i.e. 182 * 3 = 546 notions with default -minrelaytxfee = minRelayTxFee = 1000 notions per kB.
